...
MapFrame = LabelFrame(root,width=142,height=40,bg='#FFF6E0' , borderwidth=5)
MapFrame.grid(row=1,column=0,padx=15,pady=15)

MapLabel = Label(MapFrame, text='Map Will Be displayed here !',width=142, height=20, bg='#D8D9DA')
...
DataMapLabel = Label(DataFrame,text='Map',width=40,height=15,bg='lightblue',borderwidth=5)
DataMapLabel.grid(row=0,column=0,rowspan=2,padx=(10,10),pady=(30,0))
...
Graph = Label(DataFrame, text='Graph', width=50,height=13,bg='pink',borderwidth=5)
Graph.grid(row=1,column=1,columnspan=3,padx=5,pady=5)
